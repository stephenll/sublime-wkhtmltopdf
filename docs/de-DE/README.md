...
[![Sublime Text unterstützte Versionen](https://img.shields.io/badge/Sublime%20Text-Build%203118+-orange.svg?style=flat-square)](https://www.sublimetext.com)
...
* `wkhtmltopdf` ist als Erweiterung für die **neuste** Sublime Text Version gedacht und erfordert im Moment **Build 3118** oder neuer.
